  ...
  echo "</div>
        ...
        <div class='col-md-5 horniPrvni'>
          ...
          <table class='tabulkaVHlavicce'>
            ...
            <tr>
              <td align='right'><a href='./scripts/modals/pocetMereni.php?je={$_GET['je']}&amp;ja={$_GET['ja']}' class='modal'><b>{$lang['pocetmereni']}</b></a></td>
            ...
            <tr>
              <td align='right'><a href='./scripts/modals/nejTeploty.php?je={$_GET['je']}&amp;ja={$_GET['ja']}' class='modal'><b>{$lang['nejvyssiteplota']}:</a></b></td>
              <td>".jednotkaTeploty($nejvyssi['teplota'], $u, 1)." - ".formatData($nejvyssi['kdy'])."</td>
            </tr>
            <tr>
              <td align='right'><a href='./scripts/modals/nejTeploty.php?je={$_GET['je']}&amp;ja={$_GET['ja']}' class='modal'><b>{$lang['nejnizsiteplota']}:</a></b></td>
